"use strict";
  ...
  const APP_UPDATED_AT='2026-09-20 17:30';
  ...
  const HELP_TOPICS={
    ...
    settings:['設定','4つのカードから、変えたいことを選びます。','クラスと児童、画面と操作、記録の候補、データと安全に分けています。'],
    appearance:['画面と操作','画面表示、児童用表示、アイコン、下部メニューをまとめています。','「画面と児童用の表示」または「下部メニュー」を選びます。',['変更は保存後に反映されます。','下部メニューはすべてのクラスで共通です。']],
