"use strict";
  ...
  if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=58',{updateViaCache:'none'}).then(registration=>registration.update()).catch(()=>{}));
